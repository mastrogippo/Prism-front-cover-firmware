...
//
// CONNECTION:
//   Pins  9 & 10 - ATmega328, ATmega128, ATmega640, ATmega8, Uno, Leonardo,
//   etc. Pins 11 & 12 - ATmega2560/2561, ATmega1280/1281, Mega Pins 12 & 13 -
//   ATmega1284P, ATmega644 Pins 14 & 15 - Teensy 2.0 Pins 25 & 26 -
//   Teensy++ 2.0
//
// SYNTAX:
...
//       (default: 0 [forever], range: 0 to 2^32-1)
...
//#define TONEAC_TINY // Uncomment to use alternate function toneAC(frequency,
// length) that saves 110 bytes.

#if defined(__AVR_ATmega32U4__) || defined(__AVR_ATmega640__) ||  \
...
#ifndef TONEAC_TINY
void toneAC(unsigned long frequency = 0, uint8_t volume = 10,
